...
# unzip file to get example input files
zip -d test_data.zip

# test 1: no plot mode=isolation_forest (default)
python ../Evolink.py -g gene.tsv -t trait.tsv -n tree.nwk -o test1 -f

# test 2: no plot mode=gesd_test
python ../Evolink.py -g gene.tsv -t trait.tsv -n tree.nwk -o test2 -f -m gesd_test
...
# get example output
python ../Evolink.py -g gene.tsv -t trait.tsv -n tree.nwk -o test_output -f -v &> log
